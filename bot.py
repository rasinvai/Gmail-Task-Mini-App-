...
# Logging সেটআপ (যাতে এরর ভালোভাবে হ্যান্ডেল হয়)
logging.basicConfig(
    format='%(asctime)s - %(name)s - %(levelname)s - %(message)s',
    level=logging.INFO
)

# ১. BotFather থেকে পাওয়া আপনার আসল API Token দিন
TOKEN = '8783616591:AAEYGC43fEZjspF_SQ8-qWyjLPzfxfMAPYw'

# ২. আপনার Mini App-এর HTTPS লিঙ্ক দিন
WEB_APP_URL = 'https://gmailtaskminiapp.netlify.app'

# Render-কে ২৪ ঘণ্টা সচল রাখার Dummy Server
class DummyHandler(BaseHTTPRequestHandler):
    ...
    def log_message(self, format, *args):
        return  # অতিরিক্ত লোগ বাদ দেওয়ার জন্য
